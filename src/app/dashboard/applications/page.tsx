        ...
        <form action={addApplication}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
            <div>
              ...
              <input name="name" required placeholder="e.g. Somchai Jaidee" style={inputStyle} />
            </div>
            <div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', alignItems: 'flex-end' }}>
                    ...
                    <form action={deleteApplication}>
                      ...
                      <button
                        type="submit"
                        style={{ background: 'white', color: '#dc2626', border: '1px solid #fecaca', borderRadius: '6px', padding: '4px 10px', fontSize: '12px', cursor: 'pointer' }}
                      >
                        Delete
                      </button>
                    </form>
